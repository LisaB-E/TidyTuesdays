...
ggplot(nhl_births, aes(x = month, y = prop, fill = source)) +
  ...
  theme_classic()
```
Cool, but I think we don't actually need the canada births, just whether the number of birthdays in each month of NHL data is above or below the national average, rigth?
