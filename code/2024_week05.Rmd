...
I want to test how often the groundhogs get it right, so I found an epa dataset on the arrival of spring (1900-2020), and whether it's above or below expected from the 1981-2010 average bloom date
...
leaf <- read_csv("https://www.epa.gov/sites/default/files/2021-03/leaf-bloom_fig-1.csv", skip = 6) %>% 
  clean_names()
```
